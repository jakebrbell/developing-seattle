...
import OrgProfileShort from './OrgProfileShort';
  ...
  constructor() {
    ...
    this.state = {
      orgs: [{
        ...
        logoUrl: 'quinault-equality-center.jpg',
        causes: ['LGBTQ Issues'],
        ...
        email: 'jakebrbell@gmail.com',
        logoUrl: 'refugee-assistance-seattle.png',
        causes: ['Refugees'],
        ...
        email: 'jakebrbell@gmail.com',
        logoUrl: 'end-human-trafficking.jpg',
        ...
        email: 'jakebrbell@gmail.com',
        logoUrl: 'seattle-animal-shelter.jpg',
        ...
        email: 'jakebrbell@gmail.com',
        logoUrl: 'green-lake-conservation-brigade.png',
        causes: ['Environment'],
        ...
        email: 'jakebrbell@gmail.com',
        logoUrl: 'gender-justice-project.gif',
    ...
    return (
      <div>
        {this.state.orgs.map((org) => {
          return <OrgProfileShort key={org.id} org={org} />;
        })}
      </div>
    );
  }
...
export default OrgProfileShortContainer;
